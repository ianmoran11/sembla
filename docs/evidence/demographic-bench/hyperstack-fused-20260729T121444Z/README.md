...
See [`ANALYSIS.md`](ANALYSIS.md) for the negative verdict: every output matched,
but fused capacities 1/2/4 were slower than adjacent sequential CUDA at both
1M and 10M, with capacity two 44.7% and 50.7% slower respectively.
